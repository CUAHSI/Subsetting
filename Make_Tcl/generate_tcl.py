...
def read_infile(infile):
    ...
    crit_info = ['runname', 'Process.Topology.P', 'Process.Topology.Q',
...
parser.add_argument('--evap_file', type=str,
                    help='name of the PME file')

# PARAMETERS
parser.add_argument('-K', '--perm', type=float, default=0.02849,
                    help='Permeability (optional). Default is 0.02849'
                         '(i.e. average K of the Upper Colorado basin)',
                    required=False)
parser.add_argument('--porosity', type=float, default=0.39738,
                    help='Porosity (optional). Default is 0.39738 '
                         '(i.e. average porosity of the Upper Colorado basin)',
                    required=False)
...
parser.add_argument('--constant', type=int, default=0,
                    help='Constant boundary condition for top layer (optional)'
                         '. Default is No (0)',
                    required=False)
...
parser.add_argument('-s', '--start', type=float, default=0.0,
                    ...
                    required=False)
parser.add_argument('-e', '--end', type=float, help='End time (required)',
                    required=True)
parser.add_argument('--baseu', type=float, default=0.1,
                    help='Base unit(optional). Default is 0.1', required=False)
